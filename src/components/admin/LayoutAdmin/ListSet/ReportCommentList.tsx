...
import ReportHandleSelect from '../SelectBtn/ReportCommentManageBtn';
import { calculateRemainingDays } from '../../../../util/getRemaingTime';
import { formatDate } from '../../../../util/formatDate';
import { ReportCommentData } from '../../../../pages/Admin/ReportCommentPage/types';
...
const ReportPostListLayout = ({ data, reportCommentRefetch }: ReportCommentProps) => {
  const [isModal, setIsModal] = useState(false);
  const [selectValue, setSelectValue] = useState('');

  const { mutate } = useChangeUserStatusMutation();

  const user = data?.comments?.users;
  ...
  return (
    <Wrap>
      <ListOfLists>
        <ReportComment>{comment?.body}</ReportComment>
